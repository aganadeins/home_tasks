...
console.log(freeSpace, "- оставшееся место на участке");
...
console.log(ringArea, "(см2) - площадь овального кольца");
...
console.log(minNumber, "- минимальное число из трёх");
...
console.log(closerToTen, "- Ближайшее к 10 число");
...
console.log(side_ab_square, side_ac_square, side_bc_square, "- это квадраты сторон!")
